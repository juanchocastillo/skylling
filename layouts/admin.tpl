...
<head>
    ...
    <link href="{$theme}default/css/app.css?v=301" rel="stylesheet">
    ...
    <link href="{$theme}default/css/{$config['nstyle']}.css?v=301" rel="stylesheet">
...
{*                            {/if}*}
                        ...
                        {if $all_modules || isset($enabled_modules['accounting'])}
                    ...
                    {/if}
                                ...
                                <li class="{if $_application_menu eq 'invoices'}active{/if}">
                                    ...
                                    <ul class="nav nav-second-level">
                                        ...
                                        {if $config['invoicing'] eq '1'}
                                            ...
                                            {if $all_modules || isset($enabled_modules['invoicing'])}
                                        ...
                                        {if $config['quotes'] eq '1'}
                                            ...
                                            {if $all_modules || isset($enabled_modules['quotes'])}
                        ...
                        {if $all_modules || isset($enabled_modules['suppliers'])}
                        ...
                        {if $all_modules || isset($enabled_modules['purchase'])}
                        ...
                        {if $all_modules || isset($enabled_modules['leads'])}
                        ...
                        {if $all_modules || isset($enabled_modules['sms'])}
                        ...
                        {if $all_modules || isset($enabled_modules['support'])}
                        ...
                        {if $all_modules || isset($enabled_modules['kb'])}
                        ...
                        {if $all_modules || isset($enabled_modules['orders'])}
                    ...
                    {/if}
                        ...
                        {if $all_modules || isset($enabled_modules['documents'])}
                        ...
                        {if $all_modules || isset($enabled_modules['tasks'])}
                        ...
                        {if $all_modules || isset($enabled_modules['calendar'])}
                        ...
                        {if $all_modules || isset($enabled_modules['password_manager'])}
